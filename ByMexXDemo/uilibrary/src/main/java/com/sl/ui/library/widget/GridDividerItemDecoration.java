...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    int spanCount = 0;
    double rateWidth = 1.0;//父容器在屏幕的百分比 默认1
    ...
    public GridDividerItemDecoration(Context context, int dividerWidth, boolean isNeedSpace) {
        this(context,dividerWidth,0,isNeedSpace,false,1);
    }
    ...
    public GridDividerItemDecoration(Context context, int dividerWidth, int firstRowTopMargin, boolean isNeedSpace) {
        this(context,dividerWidth,firstRowTopMargin,isNeedSpace,false,1);
    }
     ...
     */
    public GridDividerItemDecoration(Context context, int dividerWidth, int firstRowTopMargin, boolean isNeedSpace, boolean isLastRowNeedSpace,double rateWidth) {
        this(context,dividerWidth,firstRowTopMargin,isNeedSpace,isLastRowNeedSpace, Color.WHITE,rateWidth);
    }
     ...
     * @param isLastRowNeedSpace 最后一行是否需要间隔
     */
    public GridDividerItemDecoration(Context context, int dividerWidth, int firstRowTopMargin, boolean isNeedSpace, boolean isLastRowNeedSpace, @ColorInt int color,double rateWidth) {
    ...
    private int getMaxDividerWidth(View view) {
        ...
        screenWidth = new Double( screenWidth*rateWidth).intValue();
    ...
    private int getAttachCloumnWidth() {
        ...
        try {
            int width = mContext.getResources().getDisplayMetrics().widthPixels > mContext.getResources().getDisplayMetrics().heightPixels
                    ? mContext.getResources().getDisplayMetrics().heightPixels : mContext.getResources().getDisplayMetrics().widthPixels;
            width = new Double( width*rateWidth).intValue();
            if(isNeedSpace)
