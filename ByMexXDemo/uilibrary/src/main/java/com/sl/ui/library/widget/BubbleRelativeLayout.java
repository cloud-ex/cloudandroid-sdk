...
public class BubbleRelativeLayout extends RelativeLayout {
    ...
    public static int BG_COLOR =  Color.argb(100, 0, 0, 0);
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                BG_COLOR= a.getInt(R.styleable.bubble_bubble_bgColor, BG_COLOR);
        ...
        mFillPaint.setColor(BG_COLOR);
        mFillPaint.setShader(new LinearGradient(100f, 0f, 100f, 200f,BG_COLOR, BG_COLOR, Shader.TileMode.CLAMP));
